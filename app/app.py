...
MODELS_QTYM: Dict = load_models_from_url(url='https://github.com/skhapijulhossen/demand-forecast-SQGroup/raw/dev/notebooks/c_Experiments/qtym_forecasting_models.pkl')
MODELS_NETPRICE: Dict = load_models_from_url(url='https://github.com/skhapijulhossen/demand-forecast-SQGroup/raw/dev/notebooks/c_Experiments/net_price_forecasting_models.pkl')
